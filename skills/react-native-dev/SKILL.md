...
| 로컬 저장 | expo-secure-store (민감), AsyncStorage (일반) | |
...
| references/state-management.md | Zustand 패턴, 영속화 | 상태 관리 구현 시 |
| references/styling.md | NativeWind v4 설정, 패턴 | 스타일링 작업 시 |
| references/build-deploy.md | 빌드, 서명, 스토어 배포 | 빌드/배포 시 |
| references/testing.md | 테스트 전략, 도구 | 테스트 작성 시 |
| references/performance.md | 성능 최적화 패턴 | 성능 개선 시 |
